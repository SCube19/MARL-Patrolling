...
class ThiefSideChannel(CustomSideChannel):
    def __init__(self) -> None:
        super().__init__(uuid.UUID("621f0a70-4f87-11ea-a6bf-784f4387d1f7"))

class GuardGroupSideChannel(CustomSideChannel):
    def __init__(self) -> None:
        super().__init__(uuid.UUID("621f0a70-4f87-11ea-a6bf-784f4387d1f8"))

class GuardSideChannel(CustomSideChannel):
    def __init__(self) -> None:
...
def create_environment_factory(
    ...
    def create_unity_environment(
        ...
        thiefSideChannel = ThiefSideChannel()
        guardSideChannel = GuardSideChannel()
        guardGroupSideChannel = GuardGroupSideChannel()
        return UnityEnvironment(
            ...
            side_channels=side_channels + [thiefSideChannel, guardSideChannel, guardGroupSideChannel],
